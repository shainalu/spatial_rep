...
def main():
    ...
    #OVR
    trainpreds,testpreds = applyOVRmodel(STspots, STpropont, collapsedy)
    np.save("STtrainpreds_051021.npy", trainpreds)
    np.save("STtestpreds_051021.npy", testpreds)
