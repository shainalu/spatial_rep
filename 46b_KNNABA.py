...
def main():
    ...
    #KNN
    ycollapse = collapsey(ABApropont)
    testpreds, trainpreds, testaurocs, trainaurocs = runknn(ycollapse, ABAvox, ABApropont)
    
    np.save("ABAknnAUROC_train_051121.npy", trainaurocs)
    np.save("ABAknnAUROC_test_051121.npy", testaurocs)
